  ...
  switch (action.type) {
    ...
    case PRODUCT_ALL_SUCCESS:
      return {
        ...
        tankTopCount: action.payload.tankTopCount,
        shirtsCount: action.payload.shirtsCount,
        polosCount: action.payload.polosCount,
        tshirtsCount: action.payload.tshirtsCount,
        shortsCount: action.payload.shortsCount,
        jeansCount: action.payload.jeansCount,
        kakiCount: action.payload.kakiCount,
